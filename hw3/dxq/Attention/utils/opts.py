import argparse
parser = argparse.ArgumentParser(description="PyTorch implementation of Time Elasitc Networks")
parser.add_argument('dataset', type=str, choices=['something','pku','ntu'])
...
parser.add_argument('--consensus_type', type=str, default='TEB')
parser.add_argument('--k', type=int, default=3)
parser.add_argument('--num_class', type=int, default=60)
parser.add_argument('--ada_type', type=str, default="teda",
                    choices=['null','type_one','type_two', "teda"])
